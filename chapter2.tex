...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=5cm]{A.figs/sevenbridges.eps}
      \hspace{1cm}
...
\begin{figure}[htp]
   \begin{center}
\begin{tabular}{ccccc}
      \includegraphics[width=2.5cm]{A.figs/link0.1.eps} &
      \includegraphics[width=2.5cm]{A.figs/link3.1.eps} &
      \includegraphics[width=2.5cm]{A.figs/link4.1.eps} &
      \includegraphics[width=2.5cm]{A.figs/2rings.eps} &
      \includegraphics[width=2.5cm]{A.figs/borromean.eps} \\
      (A) & (B) & (C) & (D) & (E) \\
\end{tabular}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
\begin{tabular}{ccccc}
      \includegraphics[width=2.5cm]{A.figs/link0.1d.eps} &
      \includegraphics[width=2.5cm]{A.figs/link3.1d.eps} &
      \includegraphics[width=2.5cm]{A.figs/link4.1d.eps} &
      \includegraphics[width=2.5cm]{A.figs/2ringsd.eps}  &
      \includegraphics[width=2.5cm]{A.figs/borromeand.eps} \\
      (A) & (B) & (C) & (D) & (E) \\
\end{tabular}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \includegraphics[width=15cm]{A.figs/reidemeistermoves.eps}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \includegraphics[width=9cm]{A.figs/surgery.eps}
   \end{center}
   \vspace{-0.7cm}
   \caption{ Oriented links}
   \label{fig:surgery}
