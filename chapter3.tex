...
\rule{0cm}{2.7cm}
\includegraphics[width=5cm]{A.figs/translationk0.eps} &
\includegraphics[width=5cm]{A.figs/translationribbonmove.eps} \\
...
The (meta-)blinks shown below induce the same space.
    \begin{center}
        \includegraphics[width=5cm]{A.figs/blinkjumpingropelemma.eps}
    \end{center}
\end{Lem}
...
result.
    \begin{center}
        \includegraphics[width=14cm]{A.figs/blinkjumpingropelemmaproof.eps}
    \end{center}
\vspace{-1cm}
\end{proof}
