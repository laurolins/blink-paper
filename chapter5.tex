...
\begin{figure}[h!tp]
   \begin{center}
      ...
      \includegraphics[width=16cm]{E.figsbw2/primespace487representants_bw.pdf}
   \end{center}
   \vspace{-0.7cm}
   \caption{A complete census of 9-small closed oriented 3-manifolds, still with two uncertainties}
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      \includegraphics[width=16cm]{E.figsbw2/primespace487representantlinks_bw.pdf}
   \end{center}
   \vspace{-0.7cm}
