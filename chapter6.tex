...
\subsection{Results, uncertainties and the need of new invariants}
...
calculus (i.e. Kirby's calculus reformulated in BFL language) we obtained
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=10cm]{A.figs/blinkcalculusoncoins.eps}
   \end{center}
   \vspace{-0.7cm}
...
which complements the HGnQI invariant. In any case (i.e. the two
...
\subsection{The inverse algorithm: from gem to blink}
...
\begin{center}
\includegraphics[width=14cm]{A.figs/euclids.eps}
\end{center}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=8cm]{A.figs/blink2gemalgorithm.eps}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=8cm]{A.figs/spacepresentationsschema.eps}
   \end{center}
   \vspace{-0.7cm}
...
\subsection{The \textsc{Blink} computer program}
...
structures into 3-gems (for instance, disconnecting quartets, dipoles) or
into g-blinks (for example, simplification points) one of the main characteristics of
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics{A.figs/coindrawing.eps}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      \includegraphics[width=14cm]{A.figs/circlepacking.eps}
   \end{center}
   \vspace{-0.7cm}
...
invariants at level $r=4$ are Gauss integers (i.e. $a + bi$ with $a,
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      \includegraphics{A.figs/blinklanguageexample.eps}
   \end{center}
   \vspace{-0.7cm}
